                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('penjual') ?>" class="nav-link active">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('penjual/add') ?>" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tambah Produk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('penjual/list') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Daftar Produk</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="obrolan.html" class="nav-link">
